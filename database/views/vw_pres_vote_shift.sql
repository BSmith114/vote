...
as
    with vote as (
        select 
            ...
            ,(dem::decimal/total::decimal)::decimal(6,5) as dem_percent
            ,(rep::decimal/total::decimal)::decimal(6,5) as rep_percent
            ,(other::decimal/total::decimal)::decimal(6,5) as oth_percent
            ,(dem::decimal/total::decimal)::decimal(6,5) - (rep::decimal/total::decimal)::decimal(6,5) as dem_margin
            ,case
                when election = 2000
                    then null
